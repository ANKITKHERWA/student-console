    ...
    <>
      <div className=" border border-[#E4E7EB] rounded-[8px] bg-white w-full pt-6 pb-7 px-6">
        <div className="flex justify-between items-center">
          <div>
            <Heading
              className="sm:text-xl! text-base! text-[#030712] font-semibold leading-[120%] tracking-[-0.4px] pt-5 "
              title="Health Score"
            />
        ...
        <div className="flex justify-between gap-2 xl:mt-10 sm:mt-6 mt-4">
