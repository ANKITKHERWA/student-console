      ...
      <div className="max-w-[1440px] mx-auto w-full min-h-dvh lg:px-8 md:px-6 sm:px-5 px-4">
        ...
        >
          ...
          <div className="w-full max-w-[440px] mx-auto mt-10">
            ...
            {step === 2 && (
              <div className="max-w-[280px] lg:max-w-[368px] mx-auto">
                <div className="flex flex-col items-center gap-1 sm:gap-2 md:gap-3">
                ...
                <form
                  ...
                  className="mt-8 max-w-[232px] mx-auto md:max-w-[280px] lg:max-w-[368px]"
                >
                        ...
                        <div className="flex flex-col justify-center mx-auto">
                          <div>
                            <InputOTPGroup className="flex gap-2 justify-center mx-auto">
                              <InputOTPSlot
                                index={0}
                                className={`!rounded-[6px] lg:w-[66px] lg:h-[66px] md:w-[50px] md:h-[50px] w-[40px] h-[40px] p-2 shadow-none bg-[white] border border-[#E4E4E7] md:text-base text-sm lg:text-xl !ring-0 ${
                                  otpError
                                    ? "border-red-500"
                                    : "border-[#E4E4E7]"
                                }`}
                              ...
                              <InputOTPSlot
                                index={1}
                                className={`!rounded-[6px] lg:w-[66px] lg:h-[66px] md:w-[50px] md:h-[50px] w-[40px] h-[40px] p-2 shadow-none bg-[white] border border-[#E4E4E7] md:text-base text-sm lg:text-xl !ring-0 font-semibold    ${
                                  otpError
                                    ? "border-red-500"
                                    : "border-[#E4E4E7]"
                                }`}
                              ...
                              />
                              <div
                                className={`!rounded-[6px] text-[#030712] font-semibold lg:w-[66px] lg:h-[66px] md:w-[50px] md:h-[50px] w-[40px] h-[40px] p-2 shadow-none bg-[#F1DCFF] border border-[#B751FB] md:text-base text-sm lg:text-xl !ring-0 flex justify-center items-center cursor-pointer`}
                              >
                                {showResend ? (
                                  <button
                                    type="button"
                                    ...
                                    className="text-[#B751FB] text-[10px] md:text-xs lg:text-sm font-semibold leading-[142.857%] -tracking-[0.28px] flex items-center justify-center underline cursor-pointer"
                                  >
                                    Resend
                                  </button>
                                ) : (
