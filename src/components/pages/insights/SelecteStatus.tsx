...
export default function SelecteStatus() {
  return (
    <Select>
      <SelectTrigger className="text-[#030712] !font-semibold !border-[#E4E7EB] !rounded-[6px] w-[189px]">
        <SelectValue
      ...
      <SelectContent className="!p-0 !m-0">
        <SelectGroup className="!p-0 !m-0">
          <SelectItem
            value="all"
            className="!p-0 !m-0 rounded-none w-full !py-[7px] !px-3 !justify-start gap-2 data-[state=checked]:bg-[#F1DCFF]"
          >
